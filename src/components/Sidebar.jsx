...
const Sidebar = () => (
    <aside className="sidebar">
        ...
        <nav className="nav bottom">
            <a href="#"><i className="fas fa-calendar-alt"></i> <span>Dashboard</span></a>
            <a href="#"><i className="fas fa-user"></i> <span>Chat</span></a>
            <a href="#"><i className="fas fa-calendar-alt"></i> <span>Event</span></a>
            <a href="#"><i className="fas fa-user"></i> <span>Employees</span></a>
            <a href="#"><i className="fas fa-cog"></i> <span>Feed</span></a>
            <a href="#"><i className="fas fa-calendar-alt"></i> <span>Recognition</span></a>
